...
>>>>>>> 8d890221e1e095a8ecdb433d4927ac01174ce7ba
    ...
    this.game.load.audio('music', 'Assets/sounds/doce.ogg');
}
...
GameState.prototype.create = function() { 
    ...
    // e o nome do layer.
    this.level1.setCollisionByExclusion([2, 22, 173, 174, 326, 481, 632, 633, 785, 786, 938, 1091, 1244, 1397, 1550, 1703, 1856, 2009, 2162, 2315],  true, this.wallsLayer);
    
    // Para o layer de lava é o caso oposto: poucos tiles colidem, então é mais fácil 
    // informar diretamente quais são.
    this.level1.setCollision([481], true, this.lavaLayer);
